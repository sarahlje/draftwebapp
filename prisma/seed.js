...
async function main() {
  // We'll skip the deleteMany step since the table was just created and is empty
  // If you need to run this repeatedly, uncomment the next line
  // await prisma.exercise.deleteMany();
  
  // Create classification objects for better data organization
  const muscleGroups = {
    CHEST: 'chest',
    BACK: 'back',
    LEGS: 'legs',
